...
require('includes/db.php');
    if (isset($_REQUEST['username'])){
		...
		if (mysqli_num_rows($result_check_unique) > 0){
		    ...
		    (fullname, password, reg_date,top_bg_color,slug,intro,avata,top_text_color) VALUES
		    ('$fullname','".md5($password)."', '$reg_date','white','$username','Giới thiệu một chút về bạn đi...','none-avata.png','black')";
